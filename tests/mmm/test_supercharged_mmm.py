...
class TestCustomMMM:
    ...
    def test_plot_components_contributions_hvplot(self, toy_X, toy_y, mock_pymc_sample):
        ...
        assert isinstance(plot_original, hv.Overlay), "Should return holoviews Overlay with original_scale"

        # Test with custom hvplot kwargs
        plot_custom = model.plot_components_contributions(width=1000, height=600)
        assert isinstance(plot_custom, hv.Overlay), "Should return holoviews Overlay with custom kwargs"
